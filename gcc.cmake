...
function(CreateBootSectorTarget _target_name _asm_file _binary_file _base_address)
    ...
    add_custom_command(
        OUTPUT ${_object_file}
        COMMAND ${CMAKE_ASM_COMPILER} -x assembler-with-cpp -o ${_object_file} -I${BOOTMANAGER_SOURCE_DIR}/include -I${BOOTMANAGER_BINARY_DIR}/sdk/include/asm ${_includes} ${_defines} -D__ASM__ -c ${_asm_file}
        DEPENDS ${_asm_file})
