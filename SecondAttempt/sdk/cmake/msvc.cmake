    ...
    if(CMAKE_VERSION VERSION_LESS 3.4.0)
        ...
        if(ARCH STREQUAL "arm")
            set(CMAKE_ASM_COMPILE_OBJECT
                "cl ${cl_includes_flag} /nologo /X /I${BOOTMANAGER_SOURCE_DIR}/sdk/include/asm /I${REACTOS_BINARY_DIR}/sdk/include/asm <FLAGS> <DEFINES> /D__ASM__ /D_USE_ML /EP /c <SOURCE> > <OBJECT>.tmp"
        ...
        if(ARCH STREQUAL "arm")
            set(CMAKE_ASM_COMPILE_OBJECT
                "cl ${cl_includes_flag} /nologo /X /I${BOOTMANAGER_SOURCE_DIR}/sdk/include/asm /I${REACTOS_BINARY_DIR}/sdk/include/asm <INCLUDES> <FLAGS> <DEFINES> /D__ASM__ /D_USE_ML /EP /c <SOURCE> > <OBJECT>.tmp"
                "<CMAKE_ASM_COMPILER> -nologo -o <OBJECT> <OBJECT>.tmp")
        else()
            set(CMAKE_ASM_COMPILE_OBJECT
                "cl ${cl_includes_flag} /nologo /X /I${BOOTMANAGER_SOURCE_DIR}/sdk/include/asm /I${REACTOS_BINARY_DIR}/sdk/include/asm <INCLUDES> <FLAGS> <DEFINES> /D__ASM__ /D_USE_ML /EP /c <SOURCE> > <OBJECT>.tmp"
...
function(CreateBootSectorTarget _target_name _asm_file _binary_file _base_address)
    ...
    add_custom_command(
        OUTPUT ${_temp_file}
        COMMAND ${CMAKE_C_COMPILER} /nologo ${_no_std_includes_flag} /I${BOOTMANAGER_SOURCE_DIR}/sdk/include/asm /I${REACTOS_BINARY_DIR}/sdk/include/asm ${_includes} ${_defines} /D__ASM__ /D_USE_ML /EP /c ${_asm_file} > ${_temp_file}
        DEPENDS ${_asm_file})
    ...
    if(MSVC_IDE AND (CMAKE_VERSION MATCHES "ReactOS"))
        ...
        foreach(_source_file ${ARGN})
            ...
            add_custom_command(
                ...
                COMMAND cl /nologo /X /I${BOOTMANAGER_SOURCE_DIR}/sdk/include/asm /I${REACTOS_BINARY_DIR}/sdk/include/asm ${_directory_includes} ${_source_file_defines} ${_directory_defines} /D__ASM__ /D_USE_ML /EP /c ${_source_file_full_path} > ${_preprocessed_asm_file} && ${_pp_asm_compile_command}
